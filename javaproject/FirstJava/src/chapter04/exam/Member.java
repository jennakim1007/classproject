...
public class Member {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			// - 짝수 해에 태어난 사람은 올해가 짝수년이라면 검사 대상이 됩니다. " 태어난해%2 == 올해년도%2 "
			// - 40 이상의 경우는 암 검사도 무료로 검사를 할 수 있습니다. : if의 중첩		
			
			System.out.println("출생연도를 입력해주세요. 종료는(0)>>> ");
			int year = in.nextInt();
			
			if(year==0) {
				System.out.println("프로그램을 종료합니다. ");
				return; // 리턴의 기능 : 메소드의 종료, 반환 
	...
	public static void checkMedical(int birthYear) {
		...
		if(age>=20) {
			...
			System.out.println("20세 미만은 무료건강검진 대상이 아닙니다.");
		}
